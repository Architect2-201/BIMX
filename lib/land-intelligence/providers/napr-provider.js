...
class NaprProvider extends BaseProvider {
  ...
  async getParcelByCadastralCode(rawCode) {
        ...
        // 2. Live NAPR Search with Session Cookies & Format Permutations
        // NOTE: No local sample intercept — ALL codes are resolved live from maps.gov.ge
        ...
        // 4. AUTHENTIC REGISTRY RULE:
        // If geometry link was blocked or shape was empty, we do NOT synthesize
        // a fake rectangle on the street. Return not-found so the user knows
        // the exact parcel geometry is unavailable, rather than showing a wrong shape.

        // 5. Authentic Registry Rule: If cadastral code is not found in official NAPR database,
        // NEVER synthesize fake rectangular plots in random fields!
